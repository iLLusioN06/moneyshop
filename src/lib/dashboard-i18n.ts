...
"header.recurring":        { tr: "Tekrarlanan İşlemler", en: "Recurring", ar: "المتكررة", ku: "Dubare", fr: "Récurrent", ru: "Повторяющиеся" },
  ...
  "header.card":             { tr: "MoneyShop Card", en: "MoneyShop Card", ar: "بطاقة MoneyShop", ku: "Karta MoneyShop", fr: "Carte MoneyShop", ru: "Карта MoneyShop" },
  ...
  // --- CARD ---
  "card.title":              { tr: "MoneyShop Card", en: "MoneyShop Card", ar: "بطاقة MoneyShop", ku: "Karta MoneyShop", fr: "Carte MoneyShop", ru: "Карта MoneyShop" },
  "card.subtitle":           { tr: "Kart bilgileriniz ve işlemleriniz", en: "Your card information and transactions", ar: "معلومات بطاقتك ومعاملاتك", ku: "Agahiyên karta te û danûstandinên te", fr: "Vos informations de carte et transactions", ru: "Информация о вашей карте и операциях" },
  "card.cardInfo":           { tr: "Kart Bilgileri", en: "Card Information", ar: "معلومات البطاقة", ku: "Agahiyên Kartê", fr: "Informations de la carte", ru: "Информация о карте" },
  "card.cardHolder":         { tr: "Kart Sahibi", en: "Card Holder", ar: "حامل البطاقة", ku: "Xwediyê Kartê", fr: "Titulaire de la carte", ru: "Держатель карты" },
  "card.expiryDate":         { tr: "Son Kullanma", en: "Expiry Date", ar: "تاريخ الانتهاء", ku: "Dîroka Bidawîbûnê", fr: "Date d'expiration", ru: "Срок действия" },
  "card.cvv":                { tr: "CVV", en: "CVV", ar: "CVV", ku: "CVV", fr: "CVV", ru: "CVV" },
  "card.cardType":           { tr: "Kart Tipi", en: "Card Type", ar: "نوع البطاقة", ku: "Tîpa Kartê", fr: "Type de carte", ru: "Тип карты" },
  "card.status":             { tr: "Durum", en: "Status", ar: "الحالة", ku: "Rewş", fr: "Statut", ru: "Статус" },
  "card.active":             { tr: "Aktif", en: "Active", ar: "نشط", ku: "Çalak", fr: "Actif", ru: "Активна" },
  "card.blocked":            { tr: "Donduruldu", en: "Blocked", ar: "محظورة", ku: "Blokkirî", fr: "Bloquée", ru: "Заблокирована" },
  "card.cancelled":          { tr: "İptal Edildi", en: "Cancelled", ar: "ملغاة", ku: "Betal Kirî", fr: "Annulée", ru: "Отменена" },
  "card.pending":            { tr: "Onay Bekliyor", en: "Pending", ar: "معلقة", ku: "Li bendê", fr: "En attente", ru: "В ожидании" },
  "card.dailyLimit":         { tr: "Günlük Limit", en: "Daily Limit", ar: "الحد اليومي", ku: "Sînorê Rojane", fr: "Limite quotidienne", ru: "Дневной лимит" },
  "card.monthlyLimit":       { tr: "Aylık Limit", en: "Monthly Limit", ar: "الحد الشهري", ku: "Sînorê Mehane", fr: "Limite mensuelle", ru: "Месячный лимит" },
  "card.dailySpent":         { tr: "Günlük Harcanan", en: "Daily Spent", ar: "المنفق اليومي", ku: "Rojane Hat Xerckirin", fr: "Dépensé aujourd'hui", ru: "Потрачено сегодня" },
  "card.monthlySpent":       { tr: "Aylık Harcanan", en: "Monthly Spent", ar: "المنفق الشهري", ku: "Mehane Hat Xerckirin", fr: "Dépensé ce mois", ru: "Потрачено в этом месяце" },
  "card.remaining":          { tr: "Kalan", en: "Remaining", ar: "المتبقي", ku: "Mayî", fr: "Restant", ru: "Осталось" },
  "card.balance":            { tr: "Kart Bakiyesi", en: "Card Balance", ar: "رصيد البطاقة", ku: "Bakiya Kartê", fr: "Solde de la carte", ru: "Баланс карты" },
  "card.recentTransactions": { tr: "Kart İşlemleri", en: "Card Transactions", ar: "معاملات البطاقة", ku: "Danûstandinên Kartê", fr: "Transactions de la carte", ru: "Операции по карте" },
  "card.noTransactions":     { tr: "Henüz kart işlemi bulunmuyor", en: "No card transactions yet", ar: "لا توجد معاملات بطاقة بعد", ku: "Hê tu danûstandinên kartê tune", fr: "Pas encore de transactions sur la carte", ru: "Операций по карте пока нет" },
  "card.blockCard":          { tr: "Kartı Dondur", en: "Block Card", ar: "تجميد البطاقة", ku: "Kartê Bloke Bike", fr: "Bloquer la carte", ru: "Заблокировать карту" },
  "card.unblockCard":        { tr: "Kartı Aktifleştir", en: "Unblock Card", ar: "إلغاء تجميد البطاقة", ku: "Kartê Çalak Bike", fr: "Débloquer la carte", ru: "Разблокировать карту" },
  "card.cancelCard":         { tr: "Kartı İptal Et", en: "Cancel Card", ar: "إلغاء البطاقة", ku: "Kartê Betal Bike", fr: "Annuler la carte", ru: "Отменить карту" },
  "card.issueDate":          { tr: "Veriliş Tarihi", en: "Issue Date", ar: "تاريخ الإصدار", ku: "Dîroka Derxistinê", fr: "Date d'émission", ru: "Дата выпуска" },
  "card.standard":           { tr: "Standart", en: "Standard", ar: "قياسية", ku: "Standard", fr: "Standard", ru: "Стандартная" },
  "card.silver":             { tr: "Silver", en: "Silver", ar: "فضية", ku: "Silver", fr: "Silver", ru: "Silver" },
  "card.gold":               { tr: "Gold", en: "Gold", ar: "ذهبية", ku: "Gold", fr: "Gold", ru: "Gold" },
  "card.upgrade":            { tr: "Kart Yükselt", en: "Upgrade Card", ar: "ترقية البطاقة", ku: "Kartê Bilind Bike", fr: "Améliorer la carte", ru: "Улучшить карту" },
  "card.upgradeDesc":        { tr: "Daha yüksek limitler ve ayrıcalıklar için kart tipinizi yükseltin.", en: "Upgrade your card type for higher limits and privileges.", ar: "قم بترقية نوع بطاقتك للحصول على حدود أعلى ومزايا.", ku: "Ji bo sînorên bilindtir û mafan tîpa karta xwe bilind bike.", fr: "Améliorez votre type de carte pour des limites et privilèges plus élevés.", ru: "Улучшите тип карты для более высоких лимитов и привилегий." },
  "card.currentPlan":        { tr: "Mevcut Plan", en: "Current Plan", ar: "الخطة الحالية", ku: "Plana Niha", fr: "Plan actuel", ru: "Текущий план" },
